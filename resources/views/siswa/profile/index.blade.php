                        ...
                        <form action="{{ route('siswa.profile.update', $siswa->id) }}" method="POST">
                            ...
                            <div class="modal-body px-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div
                                            class="input-group input-group-outline my-3 {{ $siswa->tanggal_lahir ? 'is-filled' : '' }}">
                                ...
                                <div class="card card-blog card-plain">
                                 <div class="card-header p-0 m-2 overflow-hidden" style="height: 200px; border-radius: 1rem;">
                                    <a class="d-block shadow-xl border-radius-xl h-100 w-100">
                                        @if ($keg->dokumentasi)
                                            <img src="{{ asset('storage/' . $keg->dokumentasi) }}" 
                                                alt=""
                                    ...
                                    <div class="card-body p-3">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <a href="{{ route('siswa.kegiatan.show', $keg->id) }} type="button" class="btn btn-outline-primary btn-sm mb-0">View
                                                Project</a>
